SettingsGetter = require('../getters/settings')
...
exports.cleanHTML = (props={}) ->
    ...
    displayImages ?= SettingsGetter.get state, 'messageDisplayImages'
...
exports.formatContent = (message) ->
    displayHTML = SettingsGetter.get reduxStore.getState(), 'messageDisplayHTML'
